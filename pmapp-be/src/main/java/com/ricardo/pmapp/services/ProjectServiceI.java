...
public interface ProjectServiceI {
    ...
    Project getByCode(Long code) throws ProjectNotFoundException;
    ...
    Project update(Project project, UserPrincipal requester) throws ProjectNotFoundException, ProjectUpdateException;

    void deleteByCode(Long code, UserPrincipal requester) throws ProjectNotFoundException, ProjectDeletionException;
